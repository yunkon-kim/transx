...
// BackupError provides detailed context about backup failures
...
func (e *BackupError) Error() string {
	return fmt.Sprintf("backup command execution failed for source '%s': %v", e.Source, e.Err)
}
...
// GetOutput returns the command output for debugging
func (e *BackupError) GetOutput() string {
	return e.Output
}

// RestoreError provides detailed context about restore failures
...
func (e *RestoreError) Error() string {
	return fmt.Sprintf("restore command execution failed for destination '%s': %v", e.Destination, e.Err)
}
...
// GetOutput returns the command output for debugging
func (e *RestoreError) GetOutput() string {
	return e.Output
}

// TransferError provides detailed context about transfer failures
