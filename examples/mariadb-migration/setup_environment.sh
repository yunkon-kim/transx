...
echo -e "${GREEN}migration-config.json${NC} - Local migration"
echo -e "${GREEN}remote-migration-config.json${NC} - Remote migration"
echo -e "${GREEN}server-to-vm-config.json${NC} - Server to VM migration"
echo -e "${GREEN}relay-migration-config.json${NC} - Relay migration (both source and destination are remote)"
echo ""
echo -e "${YELLOW}Check and modify configuration files:${NC}"
echo -e "${GREEN}cat server-to-vm-config.json${NC}"
...
echo -e "${GREEN}go run main.go --config=server-to-vm-config.json${NC} (Server-VM migration)"
echo -e "${GREEN}go run main.go --config=relay-migration-config.json${NC} (Relay migration)"
